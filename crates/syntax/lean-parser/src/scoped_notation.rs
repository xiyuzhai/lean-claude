...
//!
//! This module implements scoped notation declarations and attribute
//! management. Scoped notations allow defining custom syntax that is only
//! active within specific namespaces or sections.
